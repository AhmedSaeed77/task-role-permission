...
<head>
    ...
    <title>@lang('dashboard.saudi_health') | @lang('dashboard.Dashboard') | @lang('titles.Login')</title>
    ...
    <link rel="icon" href="{{ asset('website-logo.png') }}" type="image/x-icon"/>
...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ route('/') }}">@lang('dashboard.saudi_health') @lang('dashboard.Dashboard')</a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
